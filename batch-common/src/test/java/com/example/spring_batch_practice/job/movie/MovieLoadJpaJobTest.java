...
class MovieLoadJpaJobTest extends AbstractBatchIntegrationTest {

    @MockitoBean
    private MovieApiClient movieApiClient;

    @Autowired private JobLauncher jobLauncher;
    @Autowired private Job movieLoadJpaJob;
    ...
    void setUp() {
        ...
        launcher.setJob(movieLoadJpaJob);
    ...
    @Test
    void 성공_멀티페이지_멀티청크_8건_적재() throws Exception {
        given(movieApiClient.getMovies(0)).willReturn(List.of(
        ...
        assertThat(step.getReadCount()).isEqualTo(8);
