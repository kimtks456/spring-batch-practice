...
class ScheduledNotificationResendJpaJobTest extends AbstractBatchIntegrationTest {

    @MockitoBean
    private NotificationApiClient notificationApiClient;

    @Autowired private JobLauncher jobLauncher;
    @Autowired private Job scheduledNotificationResendJpaJob;
    ...
    void setUp() {
        ...
        launcher.setJob(scheduledNotificationResendJpaJob);
