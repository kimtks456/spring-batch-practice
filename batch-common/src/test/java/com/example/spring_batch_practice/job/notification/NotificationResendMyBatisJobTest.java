...
class NotificationResendMyBatisJobTest extends AbstractBatchIntegrationTest {

    @MockitoBean
    private NotificationApiClient notificationApiClient;

    @Autowired private JobLauncher jobLauncher;
    @Autowired private Job notificationResendMyBatisJob;
    ...
    void setUp() {
        ...
        launcher.setJob(notificationResendMyBatisJob);
    ...
    void 성공_fromDate_미래시_NO_TARGET_종료() throws Exception {
        ...
        assertThat(notificationLogMapper.countByStatus("FAILED")).isEqualTo(3);
    }

    @Test
    void 성공_발송_실패시_FAILED_유지() throws Exception {
        ...
        assertThat(execution.getStatus()).isEqualTo(BatchStatus.COMPLETED);
        assertThat(notificationLogMapper.countByStatus("FAILED")).isEqualTo(5);
    }
